 ...
 * @author LENOVO
 */
public class LoadImg extends Thread {
   ...
   File file;
    ...
    public LoadImg(String strUrl,Element e,Document doc,File file)
    {
    ...
    public void run() {
        ...
        url = new URL(strUrl);
            ...
            Logger.getLogger(LoadImg.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            result = null;
             try {
                 ...
                 Logger.getLogger(LoadImg.class.getName()).log(Level.SEVERE, null, ex1);
             }
            return;
        }
