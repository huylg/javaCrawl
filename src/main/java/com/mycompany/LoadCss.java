 ...
 * @author LENOVO
 */
public class LoadCss extends Thread{
   ...
   File file;
    ...
    public LoadCss(String strUrl,Element e,Document doc,File file)
    {
    ...
    public void run() {
        ...
        url = new URL(strUrl);
            ...
            Logger.getLogger(LoadCss.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            result = null;
             try {
                 ...
                 Logger.getLogger(LoadCss.class.getName()).log(Level.SEVERE, null, ex1);
             }
            return;
        }
